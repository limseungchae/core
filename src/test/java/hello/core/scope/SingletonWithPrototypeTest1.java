...
public class SingletonWithPrototypeTest1 {
    ...
    void prototypeFind() {
        ...
        PrototypeBean prototyeBean1 = ac.getBean(PrototypeBean.class);
        prototyeBean1.addCount();
        assertThat(prototyeBean1.getCount()).isEqualTo(1);

        PrototypeBean prototyeBean2 = ac.getBean(PrototypeBean.class);
        prototyeBean1.addCount();
